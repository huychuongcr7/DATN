...
class ImportOrderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('stocker.import_orders.index', compact('importOrders'));
    }
    ...
    public function create()
    {
        ...
        return view('stocker.import_orders.create', compact('products', 'suppliers'));
    }
    ...
    public function store(StoreImportOrderRequest $request)
    {
        ...
        return redirect()->route('stocker.import_orders.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('stocker.import_orders.show', compact('importOrder'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('stocker.import_orders.edit', compact('products', 'suppliers', 'importOrder', 'importOrderProducts'));
    }
