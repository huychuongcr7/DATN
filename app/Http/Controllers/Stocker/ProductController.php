...
class ProductController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('stocker.products.index', compact('products'));
    }
    ...
    public function create()
    {
        ...
        return view('stocker.products.create', compact('trademarks', 'categories', 'statuses'));
    }
    ...
    public function store(StoreProductRequest $request)
    {
        ...
        return redirect()->route('stocker.products.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('stocker.products.show', compact('product'));
    }
    ...
    public function edit($id)
    {
        ...
        $statuses = Product::$statuses;
        $product = Product::findOrFail($id);
        return view('stocker.products.edit', compact('product', 'trademarks', 'categories', 'statuses'));
    }
    ...
    public function exportImportHistory($id)
    {
        ...
        return view('stocker.products.export_import', compact('product', 'exportImports'));
    }
}
