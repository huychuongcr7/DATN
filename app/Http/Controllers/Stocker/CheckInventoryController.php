...
class CheckInventoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('stocker.check_inventories.index', compact('checkInventories'));
    }
    ...
    public function create()
    {
        ...
        return view('stocker.check_inventories.create', compact('products'));
    }
    ...
    public function store(StoreCheckInventoryRequest $request)
    {
        ...
        return redirect()->route('stocker.check_inventories.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('stocker.check_inventories.show', compact('checkInventory', 'productNews'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('stocker.check_inventories.edit', compact('products', 'checkInventory', 'checkInventoryProducts'));}
