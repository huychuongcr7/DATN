                    ...
                    <div class="card">
                        ...
                        <div class="card-action">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <a class="btn btn-default" href="{{ route('stocker.products.index') }}">
                                        <span class="btn-label">
                                            <i class="fa fa-arrow-left"></i>
                                        </span>Quay lại
                                    </a>
                                    <a class="btn btn-primary" href="{{ route('stocker.products.edit', $product->id) }}">
                                        <span class="btn-label">
                                    ...
                                    <a class="btn btn-success" href="{{ route('stocker.products.export_import', $product->id) }}">
                                        <span class="btn-label">
