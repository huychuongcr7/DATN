                        ...
                        <div class="card-body">
                            <div class=row">
                                <div class="col-md-12 text-right">
                                    ...
                                    <a class="btn btn-primary btn-round ml-auto mb-3" href="{{ route('stocker.products.export') }}">
                                        <i class="fas fa-file-export"></i>Export
                                    </a>
                                    <a href="{{ route('stocker.products.create') }}" class="btn btn-primary btn-round ml-auto mb-3">
                                ...
                                <table id="product-datatables" class="display table table-striped table-hover">
                                    ...
                                    @foreach($products as $key => $product)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('stocker.products.show', $product->id) }}">{{ $product->name }}</a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    <a href="{{ route('stocker.products.edit', $product->id) }}" type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Cập nhật">
                                                    ...
                                                    <a href="{{ route('stocker.products.export_import', $product->id) }}" type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Lịch sử xuất nhập kho">
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form method="POST" @if ($product->status == 1)action="{{ route('stocker.products.stop', $product->id) }}" @else action="{{ route('stocker.products.active', $product->id) }}" @endif>
                                                                        @csrf
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form method="POST" action="{{ route('stocker.products.destroy', $product->id) }}">
                                                                        @csrf
                                                                        @method('DELETE')
                                                    ...
                                                    <div class="modal fade" id="importModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form action="{{ route('stocker.products.import') }}" method="POST" enctype="multipart/form-data">
                                                                        @csrf
