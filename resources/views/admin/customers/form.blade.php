...
<div class="form-group form-show-validation row @error('email') has-error @enderror">
    ...
    <div class="col-lg-6 col-md-9 col-sm-8">
        <input type="email" class="form-control" id="email" name="email" placeholder="Enter Email" value="{{ old('email', isset($customer->email) ? $customer->email : null) }}">
        @error('email')
        <label class="error">{{ $message }}</label>
        @enderror
    </div>
...
<div class="form-group form-show-validation row @error('facebook_url') has-error @enderror">
    ...
    <div class="col-lg-6 col-md-9 col-sm-8">
        <input type="text" class="form-control" id="facebook_url" name="facebook_url" placeholder="Nhập facebook" value="{{ old('facebook_url', isset($customer->facebook_url) ? $customer->facebook_url : null) }}">
        @error('facebook_url')
        <label class="error">{{ $message }}</label>
        @enderror
    </div>
...
<div class="form-group row">
    ...
    <div class="col-lg-6">
        <a class="btn btn-danger" href="{{ route('admin.customers.index') }}">Hủy</a>
