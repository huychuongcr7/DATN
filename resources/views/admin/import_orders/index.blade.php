            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-flex">
                                <a href="{{ route('admin.import_orders.create') }}" class="btn btn-primary btn-round ml-auto mb-3">
                            ...
                            <div class="table-responsive">
                                <table id="basic-datatables" class="display table table-striped table-hover">
                                    ...
                                    @foreach($importOrders as $key => $importOrder)
                                        <tr>
                                            <td>{{ $loop->index + 1 }}</td>
                                            <td><a href="{{ route('admin.import_orders.show', $importOrder->id) }}">{{ $importOrder->import_order_code }}</a></td>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    <a href="{{ route('admin.import_orders.edit', $importOrder->id) }}" type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Cập nhật">
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form method="POST" action="{{ route('admin.import_orders.destroy', $importOrder->id) }}">
                                                                        @csrf
                                                                        @method('DELETE')
