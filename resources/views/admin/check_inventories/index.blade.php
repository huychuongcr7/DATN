            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-flex">
                                <a href="{{ route('admin.check_inventories.create') }}" class="btn btn-primary btn-round ml-auto mb-3">
                            ...
                            <div class="table-responsive">
                                <table id="basic-datatables" class="display table table-striped table-hover">
                                    ...
                                    @foreach($checkInventories as $key => $checkInventory)
                                        <tr>
                                            <td>{{ $loop->index + 1 }}</td>
                                            <td><a href="{{ route('admin.check_inventories.show', $checkInventory->id) }}">{{ $checkInventory->check_inventory_code }}</a></td>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    @if($checkInventory->status == \App\Models\CheckInventory::STATUS_TEMPORARY)
                                                        <a href="{{ route('admin.check_inventories.edit', $checkInventory->id) }}" type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Cập nhật">
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form method="POST" action="{{ route('admin.check_inventories.destroy', $checkInventory->id) }}">
                                                                        @csrf
                                                                        @method('DELETE')
